...
export function Certifications() {
  ...
  return (
    <section className="relative z-20 w-full bg-transparent px-4 py-32 md:px-24 overflow-hidden">
      {/* Divider */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {dict.certifications.items.map((cert, index) => (
            ...
            >
              {/* Background Glow */}
              <div className="absolute inset-0 md:-inset-8 bg-gradient-to-br from-orange-500/10 to-red-500/10 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
